...
def create_new_tables():
    ...
    CREATE INDEX idx_ranks_event_id ON "EVENT_STANDINGS"("EVENT_ID");
    ...
    CREATE INDEX idx_ev_rank_rejections_load_rpt_id ON "RANK_REJECTIONS"("LOAD_RPT_ID");
    """
    try:
